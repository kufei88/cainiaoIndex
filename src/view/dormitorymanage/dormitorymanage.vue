<template>
  <div>
    ...
    >
      ...
      <div>
        <h3>租赁宿舍:{{selectRowData.buildingName}}
    ...
    >
      ...
      >
        ...
        >
          <Input
            type="text"
            v-model="xuzuData.continuePeriod"
          />
        </FormItem>
      </Form>
      <div slot="footer">
